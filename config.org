...
;;not classified
(map! (:leader
  (:desc "gosh with splited window" "s h" (lambda () (interactive) (with-splited-window (run-scheme "")))
...
#+RESULTS:
| (lambda nil (write-to (get-today-file))) | create-node-and-link-json | org-roam-capture--insert-captured-ref-h |
